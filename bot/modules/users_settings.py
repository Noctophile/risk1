...
desp_dict = {'rcc': ['<blockquote>RClone is a command-line program to sync files and directories to and from different cloud storage providers like GDrive, OneDrive...</blockquote>', '<blockquote>Send rclone.conf. \n<b>Timeout:</b> 60 sec</blockquote>'],
            ...
            'lsuffix': ['<blockquote>Leech Filename Suffix is the End Part attached with the Filename of the Leech Files</blockquote>', '<blockquote>Send Leech Filename Suffix. Documentation Here : <a href="https://telegra.ph/BMLDDocs-09-12">Click Me</a> \n<b>Timeout:</b> 60 sec</blockquote>'],
            'lremname': ['<blockquote>Leech Filename Remname is combination of Regex(s) used for removing or manipulating Filename of the Leech Files</blockquote>', '<blockquote>Send Leech Filename Remname. Documentation Here : <a href="https://telegra.ph/BMLDDocs-09-12">Click Me</a> \n<b>Timeout:</b> 60 sec</blockquote>'],
            ...
            'usess': [f'<blockquote>User Session is Telegram Session used to Download Private Contents from Private Channels with no compromise in Privacy, Bot is Secure. You can use the session securely.Send your Session String.\n<b>Timeout:</b> 60 sec</blockquote>'],
